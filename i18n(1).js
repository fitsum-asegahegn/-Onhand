...
const translations = {
  en: {
    ...
    registerExistingTitle: "Register an Existing Product",
    registerExistingHint: "Already has a barcode from the manufacturer? Scan it instead of printing a new one — it works exactly like your own barcodes from then on.",
    scanToRegister: "Scan to Register",
    orTypeBarcodePlaceholder: "Or type the barcode",
    saveProductBtn: "Save Product",
    barcodeAlreadyRegistered: "is already registered under this barcode.",
    ...
    missedSalesTitle: "What Customers Wanted",
    missedSalesHint: "From \"Item not found?\" reports on the keeper's screen — patterns worth stocking.",
    noMissedSales: "No missed-sale reports in the last 30 days.",
    askedOnce: "Asked for once",
    askedFor: "Asked for",
    times: "times",
    lastAskedLabel: "last:",
    ...
    editBtn: "Edit",
    archiveBtn: "Archive",
    editStockHint: "To change stock, use Add Stock above instead — this keeps your stock history accurate.",
    saveChanges: "Save Changes",
    enterProductName: "Enter a product name.",
    nameUsedByAnother: "is already used by another product — pick a different name or archive one of them.",
    archiveConfirm: "Archive \"{name}\"? It'll disappear from your catalog and the keeper's scanner, but its sales history stays intact — restore it anytime from Settings.",
    archivedProductsTitle: "Archived Products",
    archivedProductsHint: "Removed from your active catalog and the keeper's scanner — restore anytime, sales history is untouched.",
    noArchivedProducts: "Nothing archived.",
    restoreBtn: "Restore",
    notificationsTitle: "🔔 Notifications",
    notificationsHint: "Local reminders only, shown while Onhand is open in your browser — not a real push notification, so it won't reach you if the app is fully closed. Surfaces new low-stock alerts and new customer requests.",
    notifEnableBtn: "Enable Notifications",
    notifEnabled: "Notifications enabled",
    notifBlocked: "Blocked — allow notifications in your browser settings",
    notifNotSupported: "Not supported on this browser",
    notifLowStockTitleSingle: "⚠️ A product needs reordering",
    notifLowStockTitleMulti: "⚠️ {n} products need reordering",
    notifMissedTitleSingle: "🔍 A customer asked for something new",
    notifMissedTitleMulti: "🔍 {n} new customer requests",
    reorderSoon: "Reorder",
    stockLeft: "left in stock.",

    scanProduct: "Scan a Product",
    tapToOpenCamera: "Tap to open the camera",
    orTypeCode: "Find a Product",
    scannerHint: "Type a product name to search, or scan/type a barcode — a wired/Bluetooth scanner works here too, typing like a keyboard.",
    typeCodePlaceholder: "e.g. Water, or a barcode",
    find: "Find",
  ...
  am: {
    ...
    navSettings: "ቅንብሮች",
    languageLabel: "ቋንቋ",
    registerExistingTitle: "ነባር እቃ መዝግብ",
    registerExistingHint: "ከአምራቹ ባርኮድ አለው? አዲስ ከማተም ይልቅ ያስካኑት — ከዚያ በኋላ እንደ የራስዎ ባርኮድ በትክክል ይሰራል።",
    scanToRegister: "ለመመዝገብ ስካን አድርግ",
    orTypeBarcodePlaceholder: "ወይም ባርኮዱን ይተይቡ",
    saveProductBtn: "እቃ አስቀምጥ",
    barcodeAlreadyRegistered: "በዚህ ባርኮድ አስቀድሞ ተመዝግቧል።",
    ...
    missedSalesTitle: "ደንበኞች የፈለጉት",
    missedSalesHint: "ከጠባቂው ገጽ \"እቃው አልተገኘም?\" ሪፖርቶች — መያዝ ተገቢ የሆኑ ንድፎች።",
    noMissedSales: "ባለፉት 30 ቀናት ውስጥ ምንም ያመለጠ ሽያጭ ሪፖርት የለም።",
    askedOnce: "አንድ ጊዜ ተጠይቋል",
    askedFor: "ተጠይቋል",
    times: "ጊዜ",
    lastAskedLabel: "መጨረሻ፦",
    addToCatalog: "ወደ ዝርዝር ጨምር",
    editBtn: "አርትዕ",
    archiveBtn: "መዝገብ ውስጥ አስቀምጥ",
    editStockHint: "ክምችት ለመቀየር ከላይ ያለውን ክምችት ጨምር ይጠቀሙ — ይህ የክምችት ታሪክዎን ትክክለኛ ያደርገዋል።",
    saveChanges: "ለውጦችን አስቀምጥ",
    enterProductName: "የእቃ ስም ያስገቡ።",
    nameUsedByAnother: "አስቀድሞ በሌላ እቃ ጥቅም ላይ ውሏል — የተለየ ስም ይምረጡ ወይም አንዱን መዝገብ ውስጥ ያስቀምጡ።",
    archiveConfirm: "\"{name}\" መዝገብ ውስጥ ይቀመጥ? ከዝርዝርዎ እና ከጠባቂው ስካነር ይጠፋል፣ ነገር ግን የሽያጭ ታሪኩ ሳይነካ ይቆያል — በማንኛውም ጊዜ ከቅንብሮች መልሰው ማምጣት ይችላሉ።",
    archivedProductsTitle: "የተመዘገቡ እቃዎች",
    archivedProductsHint: "ከንቁ ዝርዝርዎ እና ከጠባቂው ስካነር ተወግዷል — በማንኛውም ጊዜ መልሰው ያምጡ፣ የሽያጭ ታሪክ አልተነካም።",
    noArchivedProducts: "ምንም የተመዘገበ የለም።",
    restoreBtn: "መልስ አምጣ",
    notificationsTitle: "🔔 ማሳወቂያዎች",
    notificationsHint: "Onhand ክፍት እያለ ብቻ የሚታዩ የአካባቢ ማስታወሻዎች — እውነተኛ ግፊት ማሳወቂያ አይደለም፣ ስለዚህ መተግበሪያው ሙሉ በሙሉ ከተዘጋ አይደርስዎትም። አዲስ ዝቅተኛ ክምችት ማንቂያዎችን እና አዲስ የደንበኛ ጥያቄዎችን ያሳያል።",
    notifEnableBtn: "ማሳወቂያዎችን አንቃ",
    notifEnabled: "ማሳወቂያዎች ነቅተዋል",
    notifBlocked: "ታግዷል — በአሳሽዎ ቅንብሮች ውስጥ ማሳወቂያዎችን ይፍቀዱ",
    notifNotSupported: "በዚህ አሳሽ ላይ አይደገፍም",
    notifLowStockTitleSingle: "⚠️ አንድ እቃ ዳግም መዘዝ ያስፈልገዋል",
    notifLowStockTitleMulti: "⚠️ {n} እቃዎች ዳግም መዘዝ ያስፈልጋቸዋል",
    notifMissedTitleSingle: "🔍 ደንበኛ አዲስ ነገር ጠይቋል",
    notifMissedTitleMulti: "🔍 {n} አዲስ የደንበኛ ጥያቄዎች",
    reorderSoon: "ዳግም ይዘዙ",
    ...
    orTypeCode: "እቃ ፈልግ",
    scannerHint: "የእቃ ስም በመተየብ ይፈልጉ፣ ወይም ባርኮድ ያስካኑ ወይም ይተይቡ — የሽቦ/ብሉቱዝ ስካነርም እዚህ ይሰራል፣ እንደ የቁልፍ ሰሌዳ ይተይባል።",
    typeCodePlaceholder: "ለምሳሌ ውሃ፣ ወይም ባርኮድ",
    find: "ፈልግ",
    cancelScan: "ስካን ሰርዝ",
    torch: "ብርሃን",
